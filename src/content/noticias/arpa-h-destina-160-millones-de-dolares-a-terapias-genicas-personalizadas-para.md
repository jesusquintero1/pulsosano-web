---
titulo: "ARPA-H destina 160 millones de dólares a terapias génicas personalizadas para enfermedades raras"
resumen: "La agencia estadounidense ARPA-H lanzó un programa de 160 millones de dólares para impulsar tratamientos de edición génica a medida. Siete laboratorios recibirán financiamiento significativo tras retrasos relacionados con el cambio de administración."
porQueImporta: "Las enfermedades raras afectan a millones de personas en América Latina que carecen de opciones terapéuticas; el avance en edición génica personalizada podría abrir nuevas vías de tratamiento para condiciones hoy sin cura disponible."
categoria: "Avances Médicos"
fuente:
  nombre: "STAT News"
  url: "https://www.statnews.com/2026/07/09/arpa-h-160-million-custom-gene-editing-funding-rare-disease/?utm_campaign=rss"
fecha: 2026-07-09T15:00:00+00:00
tags:
  - "edicion-genica"
  - "enfermedades-raras"
  - "arpa-h"
  ...
  - "genetica"
faqs:
  - pregunta: "¿Qué es la edición génica personalizada y para qué sirve?"
    respuesta: "La edición génica personalizada es una tecnología que permite modificar secuencias específicas del ADN para corregir mutaciones asociadas a enfermedades. En el contexto de enfermedades raras, busca desarrollar tratamientos diseñados para las alteraciones genéticas particulares de cada paciente o grupo de pacientes."
  - pregunta: "¿Qué es ARPA-H y por qué financia este tipo de investigación?"
    respuesta: "Según STAT News, ARPA-H es una agencia del gobierno de Estados Unidos orientada a financiar investigaciones de alto impacto en salud que difícilmente obtendrían fondos por vías tradicionales, con el objetivo de acelerar avances médicos significativos."
  - pregunta: "¿Cuándo estarán disponibles estos tratamientos para pacientes?"
    respuesta: "El programa se encuentra en etapa de investigación y desarrollo. Los procesos de investigación, ensayos clínicos y aprobación regulatoria suelen extenderse por varios años, por lo que no se prevé disponibilidad inmediata para el público general."
  - pregunta: "¿Qué enfermedades raras podrían beneficiarse de este programa?"
    respuesta: "El material disponible no especifica qué enfermedades raras serán el foco del programa. Solo se indica que el objetivo es desarrollar terapias de edición génica personalizadas para este tipo de condiciones, muchas de las cuales tienen origen genético."
entidades:
  - nombre: "ARPA-H"
    tipo: "Organization"
  - nombre: "Edición génica"
    tipo: "MedicalProcedure"
    wikipedia: "https://es.wikipedia.org/wiki/Edici%C3%B3n_g%C3%A9nica"
...
*Fuente original: <a href="https://www.statnews.com/2026/07/09/arpa-h-160-million-custom-gene-editing-funding-rare-disease/" rel="nofollow">STAT News</a>*
