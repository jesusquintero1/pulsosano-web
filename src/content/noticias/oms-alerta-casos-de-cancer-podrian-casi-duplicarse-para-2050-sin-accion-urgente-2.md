...
resumen: "La OMS proyecta que los casos anuales de cáncer pasarán de 20,6 millones a casi 35 millones en 2050. El nuevo informe global revela profundas inequidades en acceso a diagnóstico y tratamiento entre países ricos y pobres."
porQueImporta: "América Latina enfrenta sistemas de salud con cobertura desigual y alta carga de cánceres prevenibles; las brechas documentadas por la OMS entre países de altos y bajos ingresos reflejan desafíos que afectan directamente a la región."
...
fecha: 2026-07-08T11:51:29+00:00
tags:
  - "cancer"
  - "oms"
  - "salud-publica"
  ...
  - "iarc"
faqs:
  - pregunta: "¿Cuántos casos de cáncer hay en el mundo actualmente?"
    respuesta: "Según el Informe Global de Estado del Cáncer 2026 de la OMS, se estiman actualmente 20,6 millones de nuevos casos de cáncer al año y cerca de 10 millones de muertes anuales por esta enfermedad."
  - pregunta: "¿Por qué se proyecta que el cáncer casi se duplicará para 2050?"
    respuesta: "La OMS advierte que, sin acción urgente, los casos anuales podrían alcanzar casi 35 millones para 2050, impulsados por factores como el aumento de la obesidad, la inactividad física, las dietas poco saludables y la contaminación del aire, entre otros."
  - pregunta: "¿Cuáles son los tipos de cáncer más comunes según la OMS?"
    respuesta: "Según el informe, en hombres los más frecuentes son el cáncer de pulmón, próstata y colorrectal; en mujeres, el de mama, pulmón y colorrectal representan una parte importante de la carga global. El cáncer de pulmón es la principal causa de muerte oncológica a nivel mundial."
  - pregunta: "¿Qué factores de riesgo de cáncer se pueden prevenir?"
    respuesta: "El informe de la OMS señala que casi cuatro de cada diez casos de cáncer están vinculados a factores prevenibles, como el consumo de tabaco y alcohol, el sobrepeso, la inactividad física, y las infecciones por VPH, hepatitis B y C, y Helicobacter pylori."
  - pregunta: "¿Por qué la supervivencia al cáncer es tan diferente entre países ricos y pobres?"
    respuesta: "Según el informe, el 87% de las mujeres con cáncer de mama sobreviven cinco años en países de altos ingresos, frente a solo el 42% en países de bajos ingresos. Esta brecha refleja diferencias en el acceso a detección temprana, medicamentos y tratamiento oportuno, no en la biología de la enfermedad."
entidades:
  - nombre: "Cáncer"
...
*Fuente original: [OMS – WHO Global Status Report on Cancer 2026](https://www.who.int/news/item/08-07-2026-who-calls-for-urgent-action-as-new-cancer-cases-are-projected-to-nearly-double-by-2050){rel="nofollow"}*
