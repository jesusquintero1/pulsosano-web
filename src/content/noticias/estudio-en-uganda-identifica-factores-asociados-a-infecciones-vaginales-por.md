---
titulo: "Estudio en Uganda identifica factores asociados a infecciones vaginales por Candida no albicans"
resumen: "Un estudio transversal en Uganda halló que el 23,6% de mujeres con flujo vaginal anormal tenía infección por Candida no albicans. Múltiples parejas sexuales, VIH positivo y duchas vaginales fueron los principales determinantes identificados."
porQueImporta: "Las infecciones vaginales por especies de Candida distintas a la albicans son frecuentemente resistentes a tratamientos convencionales y están subdiagnosticadas en América Latina, donde factores de riesgo similares —como el uso de antibióticos y las duchas vaginales— son comunes en la población."
categoria: "Investigación Clínica"
fuente:
  nombre: "PLOS Global Public Health"
  url: "https://journals.plos.org/globalpublichealth/article?id=10.1371/journal.pgph.0006620"
...
tags:
  ...
  - "uganda"
faqs:
  - pregunta: "¿Qué es la Candida no albicans y en qué se diferencia de la Candida albicans?"
    respuesta: "La Candida no albicans (NAC) es un grupo de especies del hongo Candida distintas a la C. albicans, como C. glabrata y C. tropicalis. Según el estudio, estas especies pueden ser más difíciles de tratar porque suelen presentar menor sensibilidad a los antifúngicos convencionales."
  - pregunta: "¿Cuáles son los factores de riesgo para una infección vaginal por Candida no albicans?"
    respuesta: "El estudio identificó como principales factores asociados tener múltiples parejas sexuales, infecciones vaginales recurrentes, ser VIH positiva, el uso de anticonceptivos, realizar duchas vaginales y el uso reciente de antibióticos."
  - pregunta: "¿Qué tan frecuente fue la infección por Candida no albicans en el estudio?"
    respuesta: "En la muestra de 314 mujeres con flujo vaginal anormal estudiadas en Uganda, el 23,6% presentó infección por Candida no albicans, siendo C. glabrata y C. tropicalis las especies más frecuentes."
  - pregunta: "¿Las duchas vaginales aumentan el riesgo de infección por hongos?"
    respuesta: "Según los resultados del estudio, la práctica de duchas vaginales se asoció con un mayor riesgo de infección por Candida no albicans (aOR 2,25). Sin embargo, para una orientación personalizada es necesario consultar con un profesional de salud."
entidades:
  - nombre: "Candida glabrata"
    tipo: "MedicalCondition"
  - nombre: "Candida tropicalis"
    tipo: "MedicalCondition"
...
*Fuente original: Idrissa SA et al. PLOS Global Public Health, 2025. <a href="https://journals.plos.org/globalpublichealth/article?id=10.1371/journal.pgph.0006620" rel="nofollow">Ver artículo original</a>.*
