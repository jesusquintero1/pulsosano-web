---
titulo: "Conflictos armados y sarampión: cómo la guerra destruye la vacunación masiva"
resumen: "Un análisis publicado en PLOS Medicine revela que los conflictos armados deterioran los sistemas de vacunación y vigilancia epidemiológica, disparando el riesgo de brotes de sarampión. El hallazgo refuerza que mantener la inmunización de rutina es, en sí mismo, una respuesta de emergencia."
porQueImporta: "América Latina ha vivido crisis humanitarias y desplazamientos masivos que pueden replicar estos patrones; entender el vínculo entre conflicto y resurgimiento del sarampión ayuda a priorizar la vacunación incluso en contextos de emergencia."
categoria: "Salud Pública y Política"
fuente:
  nombre: "PLOS Medicine"
  url: "https://journals.plos.org/plosmedicine/article?id=10.1371/journal.pmed.1005156"
...
faqs:
  - pregunta: "¿Por qué los conflictos armados aumentan el riesgo de brotes de sarampión?"
    respuesta: "Según el análisis publicado en PLOS Medicine, los conflictos destruyen instalaciones de salud, interrumpen cadenas de suministro de vacunas y provocan la pérdida de trabajadores sanitarios, lo que reduce drásticamente la cobertura de inmunización y facilita la propagación del sarampión."
  - pregunta: "¿Qué tan contagioso es el sarampión comparado con otras enfermedades?"
    respuesta: "De acuerdo con el artículo, el sarampión es la enfermedad infecciosa con mayor capacidad de contagio conocida: un solo caso puede generar hasta 18 infecciones adicionales, y el virus puede permanecer activo en el aire y en superficies hasta dos horas."
  - pregunta: "¿Qué porcentaje de cobertura vacunal se necesita para frenar el sarampión?"
    respuesta: "El análisis señala que los programas de vacunación deben alcanzar al menos el 95 % de cobertura poblacional para mantener la inmunidad de rebaño y prevenir la transmisión generalizada del sarampión."
  - pregunta: "¿Qué son los niños 'cero dosis' y cuántos hay en el mundo?"
    respuesta: "Según el artículo, los niños 'cero dosis' son infantes que no recibieron ni una sola dosis de la vacuna DTP, el indicador más básico de acceso a inmunización. El texto cita que existen 14,5 millones de estos niños en el mundo, y más de la mitad viven en países afectados por conflictos."
entidades:
  - nombre: "Sarampión"
  ...
  - nombre: "Vacuna DTP"
    tipo: "Drug"
    wikipedia: "https://es.wikipedia.org/wiki/Vacuna_DTP"
...
*Fuente: Hagan JE (2026). The well-worn path from armed conflict to measles resurgence. <a href="https://journals.plos.org/plosmedicine/article?id=10.1371/journal.pmed.1005156" rel="nofollow">PLOS Medicine 23(6): e1005156</a>.*
