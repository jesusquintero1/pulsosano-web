---
titulo: "Calor extremo y sedentarismo: por qué el verano puede arruinar tu rutina de ejercicio"
resumen: "Las olas de calor con temperaturas superiores a 42 °C favorecen el abandono del ejercicio físico, incluido el terapéutico y de rehabilitación. La Sociedad Española de Rehabilitación y Medicina Física advierte sobre las consecuencias de esta inactividad prolongada."
porQueImporta: "En América Latina, las temporadas de calor intenso son frecuentes y prolongadas, lo que puede llevar a interrupciones en rutinas de actividad física que afectan tanto la salud general como procesos de rehabilitación en curso."
categoria: "Fitness y Ejercicio"
fuente:
  nombre: "EFE Salud"
  url: "https://efesalud.com/calor-aumenta-sedentarismo-abandono-ejercicio-fisico/"
fecha: 2026-07-24T05:07:00+00:00
tags:
  - "sedentarismo"
  - "calor-extremo"
  - "ejercicio-fisico"
  ...
  - "olas-de-calor"
faqs:
  - pregunta: "¿Por qué el calor hace que la gente deje de hacer ejercicio?"
    respuesta: "Según la SERMEF, las temperaturas extremas —como las que superan los 42 °C durante una ola de calor— favorecen el sedentarismo porque el cuerpo busca refugio y reposo para protegerse del estrés térmico, lo que lleva al abandono tanto del ejercicio recreativo como del terapéutico."
  - pregunta: "¿Es peligroso dejar de hacer ejercicio durante el verano?"
    respuesta: "La Sociedad Española de Rehabilitación y Medicina Física advierte que abandonar el ejercicio físico, especialmente el terapéutico y de rehabilitación, puede tener consecuencias negativas para la salud. La duración y gravedad de esas consecuencias dependen de cada persona y situación clínica."
  - pregunta: "¿Qué pasa si interrumpo mi rehabilitación por el calor?"
    respuesta: "Según la SERMEF, interrumpir el ejercicio de rehabilitación durante períodos de calor extremo puede implicar retrocesos en la recuperación. Se recomienda consultar con el médico o fisioterapeuta antes de suspender cualquier programa terapéutico prescrito."
  - pregunta: "¿Cómo puedo mantenerme activo cuando hace mucho calor?"
    respuesta: "La fuente no detalla estrategias específicas, pero la recomendación general de los especialistas es adaptar los horarios a las horas más frescas del día, optar por espacios interiores y ajustar la intensidad del ejercicio. Siempre es preferible consultar con un profesional de la salud para orientación personalizada."
  - pregunta: "¿A quiénes afecta más el sedentarismo provocado por el calor?"
    respuesta: "Según la SERMEF, las personas que siguen programas de ejercicio terapéutico o de rehabilitación son especialmente vulnerables, ya que la interrupción de estos programas puede revertir avances en su recuperación. El material disponible no especifica otros grupos de riesgo con datos concretos."
entidades:
  - nombre: "Sedentarismo"
    tipo: "MedicalCondition"
    wikipedia: "https://es.wikipedia.org/wiki/Sedentarismo"
  - nombre: "Golpe de calor"
    tipo: "MedicalCondition"
    wikipedia: "https://es.wikipedia.org/wiki/Golpe_de_calor"
