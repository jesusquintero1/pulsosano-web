---
titulo: "Por qué se ignoran las órdenes de no reanimar en personas con discapacidad intelectual"
resumen: "Un estudio cualitativo en Inglaterra analizó 21 casos donde se aplicó reanimación cardiopulmonar pese a existir una orden de no reanimar (DNACPR). Los hallazgos revelan fallas en comunicación, documentación inaccesible y presión de emergencia como factores clave."
porQueImporta: "En América Latina, las decisiones al final de la vida en personas con discapacidad intelectual suelen estar poco documentadas y son vulnerables a las mismas fallas identificadas en este estudio, lo que hace urgente mejorar los protocolos de comunicación clínica."
categoria: "Investigación Clínica"
fuente:
  nombre: "BMJ Open"
  url: "http://bmjopen.bmj.com/cgi/content/short/16/6/e107222?rss=1"
...
tags:
  ...
  - "salud-inclusiva"
faqs:
  - pregunta: "¿Qué es una orden DNACPR y para qué sirve?"
    respuesta: "Una orden DNACPR (Do Not Attempt Cardiopulmonary Resuscitation) es una indicación médica documentada que establece que no se debe intentar la reanimación cardiopulmonar en caso de paro cardíaco. Se elabora en conjunto con el paciente, sus familiares o representantes, y debe ser respetada por el equipo de salud."
  - pregunta: "¿Por qué a veces no se respetan las órdenes de no reanimar en emergencias?"
    respuesta: "Según el estudio analizado, factores como la presión del momento de emergencia, el desconocimiento del personal sobre la existencia de la orden y fallas en la comunicación o en la accesibilidad de la documentación pueden llevar a que el personal actúe sin verificar si existe una orden DNACPR vigente."
  - pregunta: "¿Las personas con discapacidad intelectual tienen mayor riesgo de que se ignoren sus órdenes de no reanimar?"
    respuesta: "El estudio identificó 21 casos en Inglaterra donde esto ocurrió en personas con discapacidad intelectual entre 2020 y 2022. Los investigadores señalan que esta población puede ser especialmente vulnerable a fallas en la comunicación y documentación clínica, aunque el estudio no permite establecer comparaciones directas con otras poblaciones."
  - pregunta: "¿Qué se puede hacer para evitar que se ignore una orden de no reanimar?"
    respuesta: "El estudio sugiere que mejorar el intercambio de información entre equipos de salud y garantizar que la documentación sea clara y accesible son factores clave. Sin embargo, cualquier decisión sobre estas órdenes debe ser gestionada por profesionales de la salud junto con el paciente o sus representantes legales."
entidades:
  - nombre: "Reanimación cardiopulmonar"
    tipo: "MedicalProcedure"
    wikipedia: "https://es.wikipedia.org/wiki/Reanimaci%C3%B3n_cardiopulmonar"
...
*Fuente original: BMJ Open. <a href="http://bmjopen.bmj.com/cgi/content/short/16/6/e107222?rss=1" rel="nofollow">Ver artículo original</a>.*
