---
titulo: "Conflicto trabajo-familia se asocia con depresión y burnout, según metaanálisis"
resumen: "Un metaanálisis de 52 estudios longitudinales con más de 112 000 trabajadores halló que el conflicto entre las demandas laborales y familiares se asocia de forma independiente con síntomas depresivos, burnout y malestar mental general. Los hallazgos refuerzan la necesidad de políticas específicas de conciliación laboral y familiar."
porQueImporta: "En América Latina, donde las jornadas laborales extensas y las responsabilidades de cuidado familiar recaen desproporcionadamente en muchas personas, comprender el vínculo entre el conflicto trabajo-familia y la salud mental puede orientar políticas laborales y de salud pública más efectivas."
categoria: "Investigación Clínica"
fuente:
  nombre: "PLOS Medicine"
  url: "https://journals.plos.org/plosmedicine/article?id=10.1371/journal.pmed.1005162"
...
tags:
  ...
  - "bienestar-laboral"
faqs:
  - pregunta: "¿Qué es el conflicto trabajo-familia y por qué afecta la salud mental?"
    respuesta: "Según el estudio, el conflicto trabajo-familia ocurre cuando las demandas del empleo y las responsabilidades del hogar son incompatibles entre sí. Los investigadores observaron que esta tensión sostenida se asocia longitudinalmente con síntomas depresivos, burnout y malestar mental general en trabajadores adultos."
  - pregunta: "¿El conflicto trabajo-familia afecta igual a hombres y mujeres?"
    respuesta: "El metaanálisis no encontró diferencias estadísticamente significativas en la asociación entre conflicto trabajo-familia y salud mental según el género de los participantes, aunque los autores señalan que las intervenciones deben considerar las normas culturales y de género de cada contexto."
  - pregunta: "¿Cuántos estudios y participantes respaldan estos hallazgos?"
    respuesta: "El metaanálisis incluyó 52 estudios longitudinales con un total de 112 714 participantes, lo que representa una de las síntesis más amplias disponibles sobre este tema hasta la fecha de publicación."
  - pregunta: "¿El conflicto trabajo-familia causa directamente depresión o burnout?"
    respuesta: "Los autores advierten que, al tratarse exclusivamente de estudios observacionales, no es posible establecer una relación causal definitiva. Los hallazgos muestran una asociación longitudinal significativa, pero no prueban que el conflicto sea la causa directa de los problemas de salud mental."
  - pregunta: "¿Qué tipo de intervenciones sugiere el estudio para reducir este conflicto?"
    respuesta: "Según los autores, integrar la evaluación del conflicto trabajo-familia en los programas de salud ocupacional podría ser útil, y las intervenciones deberían adaptarse a los contextos socioculturales específicos, considerando sistemas de licencia parental, normas de género y apoyo organizacional. Consulta con un profesional de salud o recursos humanos para orientación personalizada."
entidades:
  - nombre: "Conflicto trabajo-familia"
    tipo: "Thing"
  - nombre: "Burnout"
    tipo: "MedicalCondition"
    wikipedia: "https://es.wikipedia.org/wiki/Síndrome_de_burnout"
  - nombre: "Depresión"
    tipo: "MedicalCondition"
...
| Desenlace | Coeficiente β | Intervalo de confianza 95% | Valor p |
|---|---|---|---|
| Síntomas depresivos | 0,10 | [0,06 – 0,15] | < 0,001 |
| Burnout (agotamiento laboral) | 0,11 | [0,01 – 0,21] | 0,040 |
| Malestar mental general | 0,13 | [0,03 – 0,24] | 0,005 |
...
*Fuente original: Liu D, Ni Y, Ma TSW, et al. Work-family conflict and mental health: A systematic review and meta-analysis. PLoS Med. 2026;23(7):e1005162. <a href="https://journals.plos.org/plosmedicine/article?id=10.1371/journal.pmed.1005162" rel="nofollow">https://doi.org/10.1371/journal.pmed.1005162</a>*
