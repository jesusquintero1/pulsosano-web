---
titulo: "Mujeres embarazadas en Nigeria desafían normas sociales para prevenir la malaria"
resumen: "Un estudio cualitativo publicado en PLOS Global Public Health exploró cómo factores comunitarios influyen en el uso del tratamiento preventivo contra la malaria en embarazadas nigerianas. Los hallazgos revelan que muchas mujeres ejercen su autonomía para acceder al tratamiento recomendado por la OMS, incluso frente a presiones familiares y culturales."
porQueImporta: "Nigeria concentra el 24.3% de las muertes mundiales por malaria, y casi el 90% de sus 7.5 millones de embarazos anuales están en riesgo. Comprender las barreras sociales que enfrentan las gestantes es clave para mejorar las estrategias de prevención en toda la región."
categoria: "Investigación Clínica"
fuente:
  nombre: "PLOS Global Public Health"
  url: "https://journals.plos.org/globalpublichealth/article?id=10.1371/journal.pgph.0006745"
...
tags:
  ...
  - "normas-sociales"
  - "prevencion-malaria"
  - "salud-publica-africa"
faqs:
  - pregunta: "¿Qué es el tratamiento preventivo IPTp-SP para la malaria en el embarazo?"
    respuesta: "Según el estudio, el IPTp-SP (tratamiento preventivo intermitente con sulfadoxina-pirimetamina) es el tratamiento recomendado por la OMS como componente central para prevenir la malaria durante el embarazo. Su uso debe ser indicado y supervisado por un profesional de salud."
  - pregunta: "¿Por qué las mujeres embarazadas son más vulnerables a la malaria?"
    respuesta: "Los investigadores señalan que el embarazo reduce la inmunidad de la mujer, lo que la hace especialmente susceptible a la infección por malaria. Esto puede tener consecuencias graves tanto para la madre como para el bebé, incluyendo anemia, bajo peso al nacer y parto prematuro."
  - pregunta: "¿Qué factores sociales influyen en que las embarazadas accedan al tratamiento preventivo contra la malaria?"
    respuesta: "Según el estudio, figuras como los esposos, suegras y líderes religiosos tienen un peso importante en las decisiones de salud de las mujeres embarazadas en Nigeria. Sin embargo, los investigadores observaron que muchas mujeres ejercen su propia agencia y priorizan su salud y la de sus bebés."
  - pregunta: "¿Qué tan grave es el problema de la malaria en Nigeria?"
    respuesta: "De acuerdo con los datos citados en el estudio, Nigeria concentra el 24.3% de todas las muertes mundiales por malaria y casi el 90% de sus 7.5 millones de embarazos anuales están en riesgo. La malaria también representa alrededor del 50% de las enfermedades reportadas entre embarazadas hospitalizadas en ese país."
entidades:
  - nombre: "Malaria en el embarazo"
    tipo: "MedicalCondition"
    wikipedia: "https://es.wikipedia.org/wiki/Malaria"
  - nombre: "Sulfadoxina-pirimetamina"
    tipo: "Drug"
    wikipedia: "https://es.wikipedia.org/wiki/Sulfadoxina/pirimetamina"
  - nombre: "Organización Mundial de la Salud"
    tipo: "Organization"
    wikipedia: "https://es.wikipedia.org/wiki/Organizaci%C3%B3n_Mundial_de_la_Salud"
imagen: "/img/noticias/mujeres-embarazadas-en-nigeria-desafian-normas-sociales-para-prevenir-la-malaria.jpg"
...
*Fuente original: Ogba P, et al. PLOS Global Public Health, 2026. <a href="https://doi.org/10.1371/journal.pgph.0006745" rel="nofollow">https://doi.org/10.1371/journal.pgph.0006745</a>*
