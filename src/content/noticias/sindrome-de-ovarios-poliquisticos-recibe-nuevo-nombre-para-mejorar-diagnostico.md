---
titulo: "Síndrome de ovarios poliquísticos recibe nuevo nombre para mejorar diagnóstico"
resumen: "Expertos globales han renombrado el síndrome de ovarios poliquísticos (SOP) como síndrome poliendocrino metabólico ovárico (SPMO) para reflejar mejor sus efectos en múltiples sistemas del cuerpo. Este cambio busca mejorar el diagnóstico y la atención de una condición que afecta a aproximadamente 1 de cada 8 mujeres en el mundo."
porQueImporta: "En América Latina, donde el acceso a diagnósticos precisos es variable, este cambio de nomenclatura puede ayudar a los profesionales sanitarios a identificar mejor la condición y a las mujeres a recibir atención más integral. La claridad en el nombre refleja que el trastorno va más allá de los ovarios, impactando múltiples sistemas hormonales y metabólicos."
categoria: "Avances Médicos"
fuente:
  nombre: "Healthline News"
  url: "https://www.healthline.com/health-news/pcos-renamed-pmos-improve-diagnosis-care-multisystem-disease"
fecha: 2026-05-20T04:04:32+00:00
tags:
