---
titulo: "Vacunación infantil repunta en las Américas, pero sarampión sigue amenazando"
resumen: "La cobertura de vacunación rutinaria en las Américas superó niveles prepandémicos en 2025, pero la cobertura contra el sarampión cayó por debajo del umbral necesario para prevenir brotes, según estimaciones de la OMS y UNICEF."
porQueImporta: "América Latina concentra desigualdades geográficas y socioeconómicas que dejan comunidades sin protección suficiente frente al sarampión, una enfermedad altamente contagiosa que ya está causando brotes activos en la región."
...
fecha: 2026-07-15T12:38:55+00:00
tags:
  - "sarampion"
  - "vacunacion"
  - "inmunizacion"
  ...
  - "americas"
faqs:
  - pregunta: "¿La vacunación infantil en América Latina ya se recuperó de la pandemia?"
    respuesta: "Según las estimaciones de la OMS y UNICEF publicadas en julio de 2026, las Américas en su conjunto no solo recuperaron los niveles de vacunación previos a la pandemia, sino que los superaron. Sin embargo, persisten brechas importantes, especialmente en la cobertura contra el sarampión."
  - pregunta: "¿Por qué el sarampión sigue causando brotes si existe una vacuna?"
    respuesta: "El sarampión requiere que al menos el 95% de la población esté vacunada con dos dosis para interrumpir su transmisión. Según el informe, la cobertura en las Américas se encuentra en 88% para la primera dosis y 78% para la segunda, muy por debajo de ese umbral, lo que deja grupos vulnerables expuestos."
  - pregunta: "¿Cuántos niños siguen sin vacunarse en las Américas?"
    respuesta: "De acuerdo con las estimaciones WUENIC 2025, el número de niños menores de un año que no recibieron ninguna vacuna disminuyó de 1,3 millones a 1,1 millones en la región de las Américas."
  - pregunta: "¿Qué es el Fondo Rotatorio de la OPS y cómo ayuda a la vacunación?"
    respuesta: "Según la OPS, el Fondo Rotatorio es un mecanismo regional que apoya a los países en el acceso oportuno y asequible a vacunas de calidad garantizada, ayudando a fortalecer los programas de inmunización y a cerrar brechas de cobertura."
  - pregunta: "¿Las Américas lideran en alguna vacuna a nivel mundial?"
    respuesta: "Sí. Según el informe de la OMS y UNICEF, las Américas son líderes mundiales en vacunación contra el virus del papiloma humano (VPH), con una cobertura del 71% en 2025, lo que refleja un compromiso sostenido para proteger a los adolescentes frente al cáncer de cuello uterino."
entidades:
  - nombre: "Sarampión"
