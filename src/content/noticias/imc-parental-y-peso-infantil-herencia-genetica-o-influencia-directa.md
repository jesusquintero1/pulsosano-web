---
titulo: "IMC parental y peso infantil: ¿herencia genética o influencia directa?"
resumen: "Un estudio noruego con miles de familias analizó si el índice de masa corporal de los padres afecta causalmente el peso y la conducta alimentaria de sus hijos, o si la relación se explica principalmente por factores genéticos compartidos."
porQueImporta: "La obesidad infantil es un problema creciente en América Latina. Entender si el peso de los padres influye directamente en el de sus hijos —o si la relación es principalmente genética— puede orientar mejor las estrategias de prevención familiar."
categoria: "Investigación Clínica"
fuente:
  nombre: "PLOS Medicine"
  url: "https://journals.plos.org/plosmedicine/article?id=10.1371/journal.pmed.1005094"
...
tags:
  ...
  - "epidemiologia"
faqs:
  - pregunta: "¿El peso de los padres determina el peso de sus hijos?"
    respuesta: "Existe una asociación conocida entre el IMC de los padres y el peso corporal de sus hijos, pero según este estudio, aún no está claro en qué medida esa relación se debe a una influencia causal directa o a factores genéticos compartidos entre padres e hijos."
  - pregunta: "¿Qué es la confusión genética en estudios de obesidad intergeneracional?"
    respuesta: "La confusión genética ocurre cuando la asociación observada entre el peso de los padres y el de los hijos se explica porque ambos comparten genes relacionados con la regulación del peso, y no porque el estado físico de los padres influya directamente en el desarrollo del hijo."
  - pregunta: "¿Cómo se midió la conducta alimentaria de los niños en este estudio?"
    respuesta: "Según los autores, las conductas alimentarias relacionadas con el apetito se evaluaron a los 8 años de edad mediante el Cuestionario de Conducta Alimentaria Infantil (CEBQ), un instrumento validado para ese propósito."
  - pregunta: "¿Por qué se comparó el IMC de la madre con el del padre en este estudio?"
    respuesta: "Comparar las asociaciones del IMC materno y paterno con los resultados del hijo es una estrategia metodológica: si el entorno intrauterino tiene un efecto causal, la madre debería mostrar una asociación más fuerte que el padre, ya que ambos aportan genes similares pero solo la madre proporciona el ambiente prenatal."
entidades:
...
*Fuente original: Bond TA et al., PLOS Medicine. <a href="https://journals.plos.org/plosmedicine/article?id=10.1371/journal.pmed.1005094" rel="nofollow">Ver artículo</a>*
