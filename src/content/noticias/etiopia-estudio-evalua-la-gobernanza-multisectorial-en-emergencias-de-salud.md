---
titulo: "Etiopía: estudio evalúa la gobernanza multisectorial en emergencias de salud pública"
resumen: "Un estudio de métodos mixtos realizado en Etiopía evaluó la madurez institucional de la gobernanza multisectorial para emergencias de salud pública. Aunque el país cuenta con marcos normativos funcionales, persisten brechas significativas entre las políticas y su aplicación real, especialmente a nivel subnacional."
porQueImporta: "Las lecciones sobre coordinación intersectorial y rendición de cuentas en emergencias sanitarias son relevantes para sistemas de salud latinoamericanos que enfrentan desafíos similares de gobernanza multinivel y brechas entre política y práctica."
categoria: "Investigación Clínica"
fuente:
  nombre: "PLOS Global Public Health"
  url: "https://journals.plos.org/globalpublichealth/article?id=10.1371/journal.pgph.0006915"
fecha: 2026-07-24T14:00:00+00:00
tags:
  ...
  - "politicas-de-salud"
faqs:
  - pregunta: "¿Qué es la gobernanza multisectorial en salud pública?"
    respuesta: "Según el estudio, la gobernanza multisectorial en salud pública se refiere a la coordinación entre múltiples sectores —como salud, gestión de desastres, agricultura y organismos internacionales— para prepararse y responder ante emergencias sanitarias de manera conjunta y coordinada."
  - pregunta: "¿Qué tan bien preparada está Etiopía para responder a emergencias de salud?"
    respuesta: "Según los investigadores, Etiopía obtuvo una puntuación de madurez de gobernanza de 3,31 sobre 5, clasificada como 'funcional'. El país cuenta con marcos normativos reconocidos, pero persisten brechas en su implementación, especialmente a nivel subnacional."
  - pregunta: "¿Cuáles son los principales problemas de coordinación identificados en el estudio?"
    respuesta: "Los autores identificaron ambigüedad de roles institucionales, prácticas inconsistentes de coordinación y reporte, mecanismos de retroalimentación débiles e implementación desigual de marcos legales, particularmente en niveles administrativos locales."
  - pregunta: "¿Quién financió este estudio sobre gobernanza en emergencias en Etiopía?"
    respuesta: "El estudio recibió apoyo financiero de la Alianza para la Investigación en Políticas y Sistemas de Salud de la OMS, el Programa de Emergencias Sanitarias de la OMS y el Gobierno de Alemania, según se indica en el artículo publicado en PLOS Global Public Health."
  - pregunta: "¿Qué significa que la implementación del marco normativo esté en nivel 'emergente'?"
    respuesta: "Según las categorías predefinidas del estudio, el nivel 'emergente' indica que la implementación del marco normativo aún está en desarrollo y no ha alcanzado un funcionamiento pleno o consistente, a diferencia de otros dominios calificados como 'funcionales'."
entidades:
  - nombre: "Gobernanza en salud pública"
    tipo: "Thing"
  - nombre: "Preparación para emergencias sanitarias"
