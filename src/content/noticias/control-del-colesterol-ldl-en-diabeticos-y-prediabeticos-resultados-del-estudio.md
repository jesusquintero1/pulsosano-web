---
titulo: "Control del colesterol LDL en diabéticos y prediabéticos: resultados del estudio SANTORINI"
resumen: "Un estudio europeo prospectivo con más de 7.000 pacientes de alto riesgo cardiovascular evaluó el control del colesterol LDL según el estado glucémico durante un año. Los hallazgos revelan brechas importantes en el cumplimiento de las metas lipídicas establecidas por las guías europeas."
porQueImporta: "En América Latina, la diabetes y las enfermedades cardiovasculares representan una carga creciente de salud pública; entender qué tan bien se controla el colesterol en personas con estas condiciones puede orientar mejoras en la atención médica regional."
categoria: "Investigación Clínica"
fuente:
  nombre: "BMJ Open"
  url: "http://bmjopen.bmj.com/cgi/content/short/16/6/e108737?rss=1"
fecha: 2026-06-29T11:58:24+00:00
tags:
  - "colesterol-ldl"
  - "diabetes"
  ...
  - "estudio-santorini"
faqs:
  - pregunta: "¿Por qué es importante controlar el colesterol LDL en personas con diabetes?"
    respuesta: "Según el estudio SANTORINI, las personas con diabetes se encuentran en la categoría de alto o muy alto riesgo cardiovascular, lo que hace que alcanzar metas estrictas de LDL-C sea especialmente relevante para reducir el riesgo de eventos como infartos o accidentes cerebrovasculares."
  - pregunta: "¿Cuáles son las metas de colesterol LDL recomendadas por las guías europeas?"
    respuesta: "De acuerdo con las guías de 2019 de la Sociedad Europea de Cardiología utilizadas en el estudio, el objetivo para pacientes de riesgo alto es un LDL-C inferior a 1,8 mmol/L (55 mg/dL), y para riesgo muy alto, inferior a 1,4 mmol/L (70 mg/dL)."
  - pregunta: "¿Qué tipo de estudio es SANTORINI y en qué países se realizó?"
    respuesta: "SANTORINI es un estudio observacional prospectivo realizado en 623 centros de atención primaria y secundaria de 14 países europeos, con más de 7.200 adultos de alto riesgo cardiovascular reclutados entre 2020 y 2021."
  - pregunta: "¿Los resultados del estudio SANTORINI aplican para pacientes en América Latina?"
    respuesta: "El estudio fue realizado en Europa, por lo que sus resultados deben interpretarse con cautela en el contexto latinoamericano, donde los sistemas de salud, el acceso a medicamentos y los perfiles de pacientes pueden diferir. Se recomienda consultar con un médico local para una evaluación personalizada."
entidades:
  - nombre: "Colesterol LDL"
    tipo: "Thing"
    wikipedia: "https://es.wikipedia.org/wiki/Lipoprote%C3%ADna_de_baja_densidad"
...
*Fuente: BMJ Open. Estudio SANTORINI. <a href="http://bmjopen.bmj.com/cgi/content/short/16/6/e108737?rss=1" rel="nofollow">Ver publicación original</a>.*
