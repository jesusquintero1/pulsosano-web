---
titulo: "RUTF vs RUSF para desnutrición aguda moderada: ensayo clínico en Etiopía"
resumen: "Un ensayo controlado aleatorizado con 2.414 niños en Etiopía halló que una dosis diaria de RUTF es igual de efectiva que el estándar de RUSF para tratar la desnutrición aguda moderada. Los resultados, publicados en PLOS Medicine, podrían orientar decisiones de abastecimiento en programas de nutrición."
porQueImporta: "América Latina enfrenta bolsas persistentes de desnutrición infantil aguda, y la elección entre suplementos nutricionales disponibles tiene implicaciones directas para la eficiencia de los programas de salud pública y la recuperación de los niños más vulnerables."
categoria: "Investigación Clínica"
fuente:
  nombre: "PLOS Medicine"
  url: "https://journals.plos.org/plosmedicine/article?id=10.1371/journal.pmed.1005199"
fecha: 2026-08-11T14:00:00+00:00
tags:
  - "desnutricion-infantil"
  - "rutf"
  - "rusf"
  - "malnutricion-aguda-moderada"
  - "nutricion-infantil"
  - "ensayo-clinico"
faqs:
  - pregunta: "¿Qué es la desnutrición aguda moderada en niños?"
    respuesta: "Según el estudio, la desnutrición aguda moderada (MAM) es una condición que afecta las medidas corporales de los niños —como la circunferencia del brazo y el peso para la talla— sin llegar a los criterios de la forma severa, pero que aumenta significativamente el riesgo de enfermar y morir. Afecta a más de 30 millones de niños en el mundo."
  - pregunta: "¿Qué diferencia hay entre RUTF y RUSF?"
    respuesta: "Ambos son suplementos nutricionales listos para usar a base de lípidos. Según el estudio, el RUSF (alimento suplementario listo para usar) fue desarrollado específicamente para la desnutrición aguda moderada, mientras que el RUTF (alimento terapéutico listo para usar) fue diseñado originalmente para la forma severa. La OMS recomienda ambos para niños con MAM que requieren suplementación."
  - pregunta: "¿Qué encontró el ensayo MODAM-MAM sobre la efectividad de estos suplementos?"
  ...
  - pregunta: "¿Cuánto tiempo tardaron los niños en recuperarse en el estudio?"
    respuesta: "Según los autores, la mediana de duración del tratamiento fue de 56 días en los tres grupos del ensayo, y las ganancias antropométricas fueron similares entre los grupos."
  - pregunta: "¿Estos resultados significan que cualquier niño con desnutrición puede recibir RUTF en lugar de RUSF?"
    respuesta: "Los hallazgos del estudio aportan evidencia para orientar programas y políticas de nutrición a nivel poblacional, no recomendaciones individuales. Cualquier decisión sobre el tratamiento de un niño con desnutrición debe ser tomada por un profesional de salud calificado que evalúe cada caso de forma individualizada."
entidades:
  - nombre: "Desnutrición aguda moderada"
    tipo: "MedicalCondition"
  - nombre: "Alimento terapéutico listo para usar (RUTF)"
    tipo: "Thing"
  - nombre: "Organización Mundial de la Salud"
    tipo: "Organization"
    wikipedia: "https://es.wikipedia.org/wiki/Organizaci%C3%B3n_Mundial_de_la_Salud"
imagen: "/img/noticias/rutf-vs-rusf-para-desnutricion-aguda-moderada-ensayo-clinico-en-etiopia.jpg"
...
| Grupo | Niños analizados | Recuperación |
|---|---|---|
| 1-RUSF (estándar) | 801 | 84,8% (679 niños) |
| 1-RUTF | 793 | 85,0% (674 niños) |
| 2-RUTF | 818 | 88,1% (721 niños) |
...
*Fuente original: Clark BA et al. (2026). PLOS Medicine, 23(8): e1005199. <a href="https://journals.plos.org/plosmedicine/article?id=10.1371/journal.pmed.1005199" rel="nofollow">https://doi.org/10.1371/journal.pmed.1005199</a>*
