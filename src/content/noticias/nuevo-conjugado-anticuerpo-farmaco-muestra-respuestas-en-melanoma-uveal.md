---
titulo: "Nuevo conjugado anticuerpo-fármaco muestra respuestas en melanoma uveal metastásico"
resumen: "Un ensayo de fase 1 publicado en Nature Medicine evaluó DYP688, un conjugado anticuerpo-fármaco dirigido a tumores con mutaciones GNAQ/GNA11, en 66 pacientes con melanoma uveal metastásico. El 71,2% presentó reducción tumoral y el 19,7% alcanzó respuesta objetiva, con un perfil de seguridad manejable."
porQueImporta: "El melanoma uveal metastásico tiene opciones terapéuticas muy limitadas y una supervivencia mediana históricamente inferior a un año; este enfoque podría ampliar las alternativas disponibles para pacientes que hoy no tienen tratamientos sistémicos aprobados."
categoria: "Investigación Clínica"
fuente:
  nombre: "Nature Medicine"
  url: "https://www.nature.com/articles/s41591-026-04518-z"
fecha: 2026-07-13T00:00:00+00:00
tags:
  - "melanoma-uveal"
  ...
  - "fase-1"
faqs:
  - pregunta: "¿Qué es el melanoma uveal metastásico y por qué es tan difícil de tratar?"
    respuesta: "El melanoma uveal es el tumor maligno intraocular primario más frecuente en adultos. Según el estudio, entre el 25 y el 34% de los pacientes desarrolla metástasis, y la supervivencia mediana tras su detección ha sido históricamente de aproximadamente un año, con opciones terapéuticas muy limitadas."
  - pregunta: "¿Qué es DYP688 y cómo funciona?"
    respuesta: "DYP688 es un conjugado anticuerpo-fármaco experimental que se une a la proteína PMEL en la superficie de las células de melanoma uveal y, una vez internalizado, libera un inhibidor de las proteínas Gq/11, que están mutadas y activas en la gran mayoría de estos tumores. Se encuentra aún en fase de investigación clínica."
  - pregunta: "¿Cuáles fueron los resultados del ensayo de fase 1 de DYP688?"
  ...
  - pregunta: "¿En qué se diferencia DYP688 de tebentafusp, el tratamiento aprobado para melanoma uveal?"
    respuesta: "Según el artículo, tebentafusp requiere que el paciente tenga el alelo HLA-A*02:01, lo que excluye a más de la mitad de los pacientes con melanoma uveal metastásico. DYP688 actúa por un mecanismo diferente que no depende de este requisito genético, lo que podría ampliar la población potencialmente tratable."
  - pregunta: "¿DYP688 ya está disponible para pacientes?"
    respuesta: "No. DYP688 es un compuesto experimental evaluado en un ensayo de fase 1 y aún no ha recibido aprobación regulatoria. Los pacientes interesados deben consultar con su médico oncólogo sobre la posibilidad de participar en ensayos clínicos activos."
entidades:
  - nombre: "Melanoma uveal"
    tipo: "MedicalCondition"
    wikipedia: "https://es.wikipedia.org/wiki/Melanoma_uveal"
...
*Fuente original: Carlino, M.S., Kapiteijn, E., Piperno-Neumann, S. et al. "An anti-PMEL antibody−drug conjugate with a Gq/11 inhibitor payload in GNAQ/GNA11-mutant melanomas: a phase 1 trial." Nat Med (2026). <a href="https://doi.org/10.1038/s41591-026-04518-z" rel="nofollow">https://doi.org/10.1038/s41591-026-04518-z</a>*
