---
titulo: "Cardiopatía congénita materna: riesgos para el desarrollo de los hijos"
resumen: "Un estudio en PLOS Medicine con más de 256,000 niños canadienses sugiere que los hijos de madres con cardiopatía congénita severa podrían enfrentar mayor vulnerabilidad en su desarrollo. El hallazgo amplía la mirada más allá de las complicaciones del embarazo."
porQueImporta: "Con el aumento de mujeres con cardiopatías congénitas que llegan a la edad reproductiva en América Latina, comprender los posibles efectos en sus hijos es clave para diseñar seguimientos pediátricos más completos."
...
fecha: 2026-07-28T14:00:00+00:00
tags:
  ...
  - "pediatria"
faqs:
  - pregunta: "¿Qué es la cardiopatía congénita y qué tan común es?"
    respuesta: "Según el artículo, las cardiopatías congénitas son malformaciones del corazón presentes desde el nacimiento y constituyen el grupo más frecuente de malformaciones congénitas, con una prevalencia de aproximadamente 1% en los nacidos vivos en todo el mundo."
  - pregunta: "¿Las mujeres con cardiopatía congénita pueden quedar embarazadas?"
    respuesta: "De acuerdo con los autores, la fertilidad no parece estar marcadamente afectada en mujeres con cardiopatía congénita, aunque quienes tienen formas más severas tienen menos probabilidades de tener hijos. Sin embargo, el embarazo en estas mujeres requiere seguimiento médico especializado por el mayor riesgo de complicaciones."
  - pregunta: "¿Los hijos de madres con cardiopatía congénita tienen más riesgo de nacer con el mismo problema?"
    respuesta: "Según un estudio danés citado en el artículo, el riesgo de recurrencia de cardiopatía congénita en los hijos es de 4,8% cuando la madre está afectada, comparado con 2,7% cuando el padre es quien tiene la condición, lo que sugiere la influencia tanto de factores genéticos como del ambiente intrauterino."
  - pregunta: "¿Qué complicaciones del embarazo se asocian a la cardiopatía congénita materna?"
    respuesta: "El artículo menciona que varios estudios epidemiológicos han reportado asociaciones entre la cardiopatía congénita materna y complicaciones como restricción del crecimiento fetal, preeclampsia, parto prematuro y pérdida fetal, además de mayor riesgo de arritmias e insuficiencia cardíaca en la madre."
  - pregunta: "¿Qué riesgos de desarrollo tienen los hijos de madres con cardiopatía congénita severa?"
    respuesta: "Según el estudio comentado en el artículo, los hijos de madres con cardiopatía congénita, especialmente severa, podrían presentar mayor vulnerabilidad en áreas del desarrollo como salud física, competencia social, madurez emocional y lenguaje, evaluadas alrededor de los 5 a 6 años de edad. Los autores advierten que aún no está claro si este riesgo es independiente de la prematuridad u otros factores."
entidades:
  ...
  - nombre: "Restricción del crecimiento fetal"
    tipo: "MedicalCondition"
    wikipedia: "https://es.wikipedia.org/wiki/Restricci%C3%B3n_del_crecimiento_intrauterino"
  - nombre: "Preeclampsia"
    tipo: "MedicalCondition"
...
*Fuente original: Leirgul E, Greve G (2026). Maternal congenital heart disease: Implications for the next generation. PLoS Med 23(7): e1005191. <a href="https://journals.plos.org/plosmedicine/article?id=10.1371/journal.pmed.1005191" rel="nofollow">https://doi.org/10.1371/journal.pmed.1005191</a>*
