---
titulo: "OMS propone marco para fortalecer agencias de salud pública ante emergencias"
resumen: "Un artículo publicado en PLOS Global Public Health analiza el marco de capacidades de la OMS para agencias nacionales de salud pública, argumentando que debe usarse como agenda de reforma institucional y no solo como herramienta de evaluación comparativa."
porQueImporta: "Muchos países de América Latina cuentan con agencias de salud pública con mandatos legales ambiguos y dependencia de donantes externos, exactamente las debilidades que este marco busca corregir para mejorar la respuesta ante futuras pandemias."
categoria: "Salud Pública y Política"
fuente:
  nombre: "PLOS Global Public Health"
  url: "https://journals.plos.org/globalpublichealth/article?id=10.1371/journal.pgph.0006882"
fecha: 2026-07-17T14:00:00+00:00
tags:
  - "salud-publica"
  - "oms"
  - "preparacion-emergencias"
  - "agencias-salud-publica"
  - "gobernanza-sanitaria"
  - "seguridad-sanitaria"
faqs:
  - pregunta: "¿Qué es el marco de capacidades de la OMS para agencias nacionales de salud pública?"
    respuesta: "Según el artículo, es un documento de la OMS que define 12 capacidades interdependientes —en dominios fundacionales y técnicos— que las agencias nacionales de salud pública deben tener para responder eficazmente ante emergencias sanitarias."
  - pregunta: "¿Por qué falló la respuesta de muchos países ante el COVID-19 si tenían planes de emergencia?"
    respuesta: "Los autores señalan que las debilidades no fueron principalmente técnicas, sino de gobernanza: fragmentación de la autoridad, falta de rendición de cuentas y ausencia de un organismo con poder real para coordinar la respuesta a lo largo del ciclo de emergencia."
  - pregunta: "¿Cuántos países tienen una agencia nacional de salud pública?"
    respuesta: "Según el artículo, para 2025 más de 120 países habían establecido o estaban estableciendo este tipo de institución, en comparación con menos de 60 alrededor del año 2000."
  - pregunta: "¿El marco de la OMS obliga a los países a crear una agencia nacional de salud pública?"
    respuesta: "No. Según los autores, el marco reconoce que las agencias nacionales de salud pública no son el único camino posible y describe cuatro estructuras de gobernanza ilustrativas, reconociendo que la forma institucional debe adaptarse al contexto de cada país."
  - pregunta: "¿Qué diferencia hay entre países ricos y países de ingresos medios y bajos en cuanto a estas agencias?"
    respuesta: "El artículo señala que en países de altos ingresos las agencias suelen tener autoridad legal, financiamiento propio e independencia científica reconocida, mientras que en muchos países de ingresos bajos y medios operan con mandatos ambiguos, dependencia de donantes externos y capacidad limitada de personal."
entidades:
...
*Fuente original: Namara G, Smallwood C, Zuber A, Hersey S, Ihekweazu C (2026). Beyond benchmarking: Using WHO's NPHA capability framework as a driver of institutional reform. PLOS Global Public Health 6(7): e0006882. <a href="https://journals.plos.org/globalpublichealth/article?id=10.1371/journal.pgph.0006882" rel="nofollow">Ver fuente</a>*
