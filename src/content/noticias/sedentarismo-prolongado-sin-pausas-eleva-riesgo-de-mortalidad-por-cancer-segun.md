---
titulo: "Sedentarismo prolongado sin pausas eleva riesgo de mortalidad por cáncer, según estudio"
resumen: "Un estudio con más de 91,000 participantes del UK Biobank halló que cada hora adicional de sedentarismo prolongado e ininterrumpido se asocia con mayor riesgo de morir por cáncer. La investigación sugiere que interrumpir el tiempo sentado podría marcar una diferencia importante."
porQueImporta: "En América Latina, los estilos de vida cada vez más sedentarios —especialmente en entornos laborales y urbanos— hacen que estos hallazgos sean especialmente relevantes para la prevención del cáncer en la región."
categoria: "Investigación Clínica"
fuente:
  nombre: "PLOS Medicine"
  url: "https://journals.plos.org/plosmedicine/article?id=10.1371/journal.pmed.1004767"
...
tags:
  ...
  - "uk-biobank"
faqs:
  - pregunta: "¿Qué diferencia hay entre sedentarismo prolongado y sedentarismo interrumpido?"
    respuesta: "Según el estudio, el sedentarismo prolongado se refiere a períodos continuos de inactividad sin pausas, mientras que el sedentarismo interrumpido implica que ese tiempo inactivo se fracciona con pequeños movimientos o actividad física. Los investigadores encontraron que esta distinción podría tener consecuencias distintas para el riesgo de cáncer."
  - pregunta: "¿Cuánto aumenta el riesgo de morir por cáncer por cada hora de sedentarismo prolongado?"
    respuesta: "De acuerdo con los resultados del estudio, cada hora adicional de sedentarismo prolongado se asoció con una razón de riesgo de 1,09 para la mortalidad por cáncer en general, tras ajustar por factores sociodemográficos y de estilo de vida."
  - pregunta: "¿A quiénes se aplicó este estudio sobre sedentarismo y cáncer?"
    respuesta: "El estudio analizó datos de 91,292 participantes del UK Biobank con mediciones objetivas de actividad física mediante acelerómetros, seguidos durante una mediana de aproximadamente 12 años. La muestra proviene del Reino Unido, lo que puede limitar su generalización directa a otras poblaciones."
  - pregunta: "¿Interrumpir el tiempo sentado puede reducir el riesgo de cáncer?"
    respuesta: "Los modelos de sustitución isotemporal del estudio sugieren que reemplazar sedentarismo prolongado por sedentarismo intermitente o por actividad física podría asociarse con un menor riesgo. Sin embargo, al tratarse de un estudio observacional, no se puede establecer causalidad definitiva. Se recomienda consultar con un profesional de salud antes de realizar cambios significativos en los hábitos."
entidades:
  - nombre: "Sedentarismo"
...
*Fuente original: Zhou Z. et al., PLOS Medicine. [Ver artículo](https://journals.plos.org/plosmedicine/article?id=10.1371/journal.pmed.1004767){rel="nofollow"}*
