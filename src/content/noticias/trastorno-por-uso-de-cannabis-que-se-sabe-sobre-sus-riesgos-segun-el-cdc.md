---
titulo: "Trastorno por uso de cannabis: qué se sabe sobre sus riesgos según el CDC"
resumen: "El CDC advierte que el trastorno por uso de cannabis puede afectar la atención, la memoria y el aprendizaje, y que la concentración de THC en los productos ha aumentado significativamente en las últimas décadas, elevando el riesgo de consecuencias negativas."
porQueImporta: "El consumo de cannabis está en aumento en América Latina, y la disponibilidad de productos con altas concentraciones de THC hace que comprender sus riesgos sea cada vez más relevante para la salud pública regional."
...
fecha: 2026-05-30T17:50:18+00:00
tags:
  - "cannabis"
  - "thc"
...
faqs:
  - pregunta: "¿Qué es el trastorno por uso de cannabis?"
    respuesta: "Según el CDC, es una condición en la que una persona puede necesitar consumir cantidades cada vez mayores de cannabis o productos más potentes para obtener el mismo efecto, y puede estar asociada a problemas con la atención, la memoria y el aprendizaje."
  - pregunta: "¿Ha aumentado la potencia del cannabis con el tiempo?"
    respuesta: "Sí. Un estudio citado por el CDC encontró que la concentración promedio de THC casi se duplicó entre 2008 y 2017, pasando del 9% al 17%, y que productos en dispensarios en línea pueden alcanzar concentraciones promedio del 22%."
  - pregunta: "¿Los jóvenes tienen más riesgo con el cannabis de alta potencia?"
    respuesta: "El CDC señala que existe evidencia moderada de que el consumo de cannabis con alta concentración de THC en adolescentes y adultos jóvenes se asocia con el uso continuado y con el desarrollo futuro de síntomas y trastornos de salud mental."
  - pregunta: "¿Qué métodos de consumo de cannabis son más riesgosos?"
    respuesta: "Según el CDC, métodos como el dabbing y el vapeo de concentrados pueden entregar niveles muy altos de THC al organismo, lo que aumenta el riesgo de efectos intoxicantes intensos y sobreconsumo."
entidades:
  - nombre: "Trastorno por uso de cannabis"
    tipo: "MedicalCondition"
    wikipedia: "https://es.wikipedia.org/wiki/Trastorno_por_uso_de_cannabis"
  - nombre: "Tetrahidrocannabinol"
    tipo: "Drug"
    wikipedia: "https://es.wikipedia.org/wiki/Tetrahidrocannabinol"
...
*Fuente: <a href="https://www.cdc.gov/cannabis/health-effects/cannabis-use-disorder.html" rel="nofollow">CDC – Cannabis Use Disorder</a>*
