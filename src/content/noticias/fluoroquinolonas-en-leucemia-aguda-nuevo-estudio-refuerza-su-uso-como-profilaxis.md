---
titulo: "Fluoroquinolonas en leucemia aguda: nuevo estudio refuerza su uso como profilaxis antibiótica"
resumen: "Un estudio aporta nuevas evidencias a favor del uso de fluoroquinolonas como profilaxis antibiótica en pacientes con leucemia aguda, en un debate donde incluso se plantea abandonar esta práctica. Los hallazgos sugieren que, antes de prescindir de ella, serían necesarias alternativas sólidas."
porQueImporta: "La leucemia aguda afecta a miles de personas en América Latina cada año, y las infecciones durante el tratamiento son una causa importante de complicaciones graves; cualquier evidencia sobre cómo prevenirlas tiene impacto directo en la sobrevida de los pacientes."
categoria: "Investigación Clínica"
fuente:
  nombre: "Diario Médico"
  url: "https://www.diariomedico.com/medicina/hematologia/mas-pruebas-favor-fluoroquinolonas-leucemia-aguda.html"
fecha: 2026-07-11T06:00:00+00:00
tags:
  - "leucemia-aguda"
  - "fluoroquinolonas"
  ...
  - "neutropenia"
faqs:
  - pregunta: "¿Qué son las fluoroquinolonas y para qué se usan en leucemia aguda?"
    respuesta: "Las fluoroquinolonas son una familia de antibióticos de amplio espectro. En pacientes con leucemia aguda, según el material de Diario Médico, se han utilizado de forma preventiva para reducir el riesgo de infecciones bacterianas graves durante los períodos en que la quimioterapia debilita el sistema inmunitario."
  - pregunta: "¿Por qué se debate si abandonar la profilaxis antibiótica en leucemia aguda?"
    respuesta: "Según Diario Médico, la práctica es objeto de discusión en la comunidad médica, posiblemente por preocupaciones relacionadas con la resistencia bacteriana. Sin embargo, el material señala que antes de abandonarla sería necesario contar con alternativas igualmente eficaces."
  - pregunta: "¿Qué encontró el nuevo estudio sobre fluoroquinolonas en leucemia?"
    respuesta: "De acuerdo con Diario Médico, el estudio aporta nuevas pruebas a favor del uso de fluoroquinolonas como profilaxis antibiótica en leucemia aguda, reforzando la posición de quienes defienden mantener esta estrategia preventiva mientras no existan alternativas validadas."
  - pregunta: "¿Puede un paciente con leucemia decidir por su cuenta tomar antibióticos preventivos?"
    respuesta: "No. El uso de antibióticos profilácticos en pacientes con leucemia es una decisión clínica compleja que debe ser tomada exclusivamente por el equipo médico tratante, considerando el perfil individual del paciente y los patrones locales de resistencia bacteriana."
  - pregunta: "¿La resistencia a antibióticos afecta el tratamiento de la leucemia en América Latina?"
    respuesta: "La resistencia antimicrobiana es un problema relevante en la región y puede influir en la efectividad de la profilaxis antibiótica. Por eso, las decisiones sobre qué antibióticos usar deben considerar los perfiles de resistencia locales, que varían entre países y hospitales."
entidades:
  - nombre: "Leucemia aguda"
    tipo: "MedicalCondition"
    wikipedia: "https://es.wikipedia.org/wiki/Leucemia_aguda"
