---
titulo: "60% de pacientes tribales con enfermedades cardíacas en India no toman sus medicamentos"
resumen: "Un estudio exploratorio en comunidades tribales del sur de India halló que 6 de cada 10 pacientes con enfermedades cardiovasculares y múltiples condiciones crónicas no cumplían con su tratamiento. La baja escolaridad, la diabetes y la alta cantidad de pastillas diarias fueron los principales factores asociados al abandono."
porQueImporta: "Aunque el estudio se realizó en India, sus hallazgos son relevantes para América Latina, donde comunidades indígenas y rurales enfrentan barreras similares —educativas, culturales y de acceso— para adherirse a tratamientos de enfermedades crónicas cardiovasculares."
categoria: "Investigación Clínica"
fuente:
  nombre: "BMJ Open"
  url: "http://bmjopen.bmj.com/cgi/content/short/16/7/e112120?rss=1"
fecha: 2026-07-07T09:52:41+00:00
tags:
  ...
  - "polifarmacia"
faqs:
  - pregunta: "¿Por qué los pacientes con enfermedades del corazón dejan de tomar sus medicamentos?"
    respuesta: "Según este estudio, factores como la baja escolaridad, tener varias enfermedades al mismo tiempo y la alta cantidad de pastillas diarias se asociaron significativamente con no cumplir el tratamiento cardiovascular en la población analizada."
  - pregunta: "¿Qué es la multimorbilidad y por qué complica el tratamiento?"
    respuesta: "La multimorbilidad se refiere a tener dos o más enfermedades crónicas al mismo tiempo. En el estudio, los participantes presentaban principalmente hipertensión, diabetes y enfermedad renal crónica, lo que implica tomar múltiples medicamentos y aumenta el riesgo de no adherirse al tratamiento."
  - pregunta: "¿A quiénes afecta más la falta de adherencia a medicamentos cardiovasculares?"
    respuesta: "De acuerdo con los investigadores, las personas con menor nivel educativo, quienes padecen diabetes además de enfermedades cardiovasculares y quienes deben tomar muchos medicamentos al día presentaron mayor probabilidad de no seguir su tratamiento correctamente."
  - pregunta: "¿Qué se puede hacer para mejorar la adherencia al tratamiento en comunidades vulnerables?"
    respuesta: "Los autores del estudio sugieren desarrollar estrategias de implementación culturalmente sensibles que consideren las barreras educativas y sociales de estas comunidades. Cualquier cambio en el tratamiento debe consultarse siempre con un profesional de la salud."
entidades:
  - nombre: "Enfermedad cardiovascular"
    tipo: "MedicalCondition"
    wikipedia: "https://es.wikipedia.org/wiki/Enfermedad_cardiovascular"
  - nombre: "Adherencia al tratamiento"
