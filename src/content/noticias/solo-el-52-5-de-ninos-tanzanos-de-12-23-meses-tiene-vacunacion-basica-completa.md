---
titulo: "Solo el 52.5% de niños tanzanos de 12-23 meses tiene vacunación básica completa"
resumen: "Un análisis de la Encuesta Demográfica y de Salud 2022 de Tanzania reveló que apenas la mitad de los niños de 12 a 23 meses tiene el esquema básico de vacunación completo. El hallazgo evidencia brechas persistentes en la cobertura infantil en África Subsahariana."
porQueImporta: "Las brechas de vacunación infantil no son exclusivas de África: en varios países latinoamericanos la cobertura también ha caído tras la pandemia, y los factores asociados —acceso geográfico, nivel educativo, ruralidad— son similares. Comprender qué obstaculiza la vacunación completa ayuda a diseñar políticas más efectivas en la región."
categoria: "Investigación Clínica"
fuente:
  nombre: "PLOS Global Public Health"
  url: "https://journals.plos.org/globalpublichealth/article?id=10.1371/journal.pgph.0004810"
...
tags:
  ...
  - "esquema-basico"
faqs:
  - pregunta: "¿Qué porcentaje de niños en Tanzania tiene la vacunación completa?"
    respuesta: "Según el análisis de la Encuesta Demográfica y de Salud 2022 de Tanzania, solo el 52.5% de los niños de 12 a 23 meses había completado el esquema básico de vacunación, lo que equivale a aproximadamente uno de cada dos niños."
  - pregunta: "¿Por qué muchos niños no completan su esquema de vacunación?"
    respuesta: "El estudio identificó factores individuales y comunitarios asociados a la cobertura incompleta, aunque no detalla todos en el resumen disponible. En general, la investigación en salud pública señala que barreras como la distancia a los centros de salud, el nivel socioeconómico y características del entorno comunitario influyen en la continuidad del proceso de vacunación."
  - pregunta: "¿Qué vacunas tienen mayor cobertura en Tanzania según este estudio?"
    respuesta: "De acuerdo con los datos analizados, la BCG (contra formas graves de tuberculosis) alcanzó una cobertura del 91.0%, y la primera dosis de la vacuna contra el sarampión llegó al 86.5%. Sin embargo, la cobertura del esquema completo fue considerablemente menor."
  - pregunta: "¿Cuántas muertes evita la vacunación infantil cada año?"
    respuesta: "Según se indica en el estudio publicado en PLOS Global Public Health, la vacunación previene entre 4 y 5 millones de muertes a nivel mundial cada año, muchas de ellas en niños menores de cinco años."
entidades:
...
*Fuente original: Oguma ED et al. PLOS Global Public Health, 2025. <a href="https://journals.plos.org/globalpublichealth/article?id=10.1371/journal.pgph.0004810" rel="nofollow">Ver artículo</a>.*
