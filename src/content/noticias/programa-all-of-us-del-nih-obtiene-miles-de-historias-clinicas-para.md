---
titulo: "Programa 'All of Us' del NIH obtiene miles de historias clínicas para investigación"
resumen: "El Programa de Investigación 'All of Us' de los NIH accedió a miles de registros médicos electrónicos mediante redes de intercambio de datos de pacientes. Este enfoque innovador busca cerrar brechas de información en la investigación biomédica."
porQueImporta: "El acceso a datos clínicos reales y diversos es clave para que la investigación biomédica refleje mejor a poblaciones históricamente subrepresentadas, incluidas las latinoamericanas. Iniciativas como esta podrían influir en cómo se diseñan futuros estudios de salud a escala global."
...
tags:
  ...
  - "all-of-us"
faqs:
  - pregunta: "¿Qué es el programa 'All of Us' de los NIH?"
    respuesta: "Es una iniciativa de los Institutos Nacionales de Salud de Estados Unidos que busca recopilar datos de salud de una gran cantidad de personas diversas para impulsar la investigación biomédica y la medicina de precisión."
  - pregunta: "¿Cómo obtuvo 'All of Us' los registros médicos electrónicos?"
    respuesta: "Según STAT News, el programa utilizó redes de intercambio de datos de pacientes como mecanismo innovador para acceder a miles de historias clínicas electrónicas."
  - pregunta: "¿Para qué sirven los registros médicos electrónicos en la investigación?"
    respuesta: "Permiten a los investigadores estudiar enfermedades y tratamientos en poblaciones amplias y diversas, usando datos generados durante la atención médica cotidiana, lo que complementa los ensayos clínicos tradicionales."
  - pregunta: "¿Qué vacíos de datos busca llenar este programa?"
    respuesta: "De acuerdo con la información disponible, el programa apunta a completar brechas de información en su base de datos, especialmente para lograr una representación más amplia y diversa de la población en la investigación biomédica."
entidades:
  - nombre: "All of Us Research Program"
    tipo: "Organization"
  - nombre: "Registros médicos electrónicos"
    tipo: "Thing"
    wikipedia: "https://es.wikipedia.org/wiki/Historia_cl%C3%ADnica_electr%C3%B3nica"
...
*Fuente original: <a href="https://www.statnews.com/2026/06/30/nih-all-of-us-program-taps-ehr-records-fill-data-gaps/" rel="nofollow">STAT News</a>*
