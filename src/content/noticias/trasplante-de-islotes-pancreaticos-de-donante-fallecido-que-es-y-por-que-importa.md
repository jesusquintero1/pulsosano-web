---
titulo: "Trasplante de islotes pancreáticos de donante fallecido: qué es y por qué importa para la diabetes tipo 1"
resumen: "Investigadores y organizaciones impulsan la expansión del trasplante de células de islotes de donantes fallecidos como alternativa terapéutica para adultos con diabetes tipo 1 severa. La organización Breakthrough T1D presiona al gobierno de EE. UU. para reclasificar estas células y ampliar su acceso."
porQueImporta: "Para la comunidad latinoamericana con diabetes tipo 1, conocer los avances en trasplantes de islotes pancreáticos abre una perspectiva sobre posibles opciones terapéuticas futuras que podrían reducir o eliminar la dependencia de insulina exógena."
categoria: "Enfermedades y Tratamientos"
fuente:
  nombre: "MedlinePlus News (NIH)"
  url: "https://www.breakthrought1d.org/news-and-updates/deceased-donor-islet-cell-transplantation-101/"
fecha: 2026-06-01T01:34:18+00:00
tags:
  - "diabetes-tipo-1"
  ...
  - "terapia-celular"
faqs:
  - pregunta: "¿En qué consiste el trasplante de islotes pancreáticos de donante fallecido?"
    respuesta: "Según Breakthrough T1D, es un procedimiento en el que se aíslan células productoras de insulina del páncreas de un donante fallecido y se infunden en el hígado de una persona con diabetes tipo 1, con el objetivo de restaurar la producción de insulina."
  - pregunta: "¿Para quién está indicado este tipo de trasplante?"
    respuesta: "De acuerdo con el material de Breakthrough T1D, la investigación disponible lo evalúa en adultos con diabetes tipo 1 que experimentan hipoglucemia severa e hipoglucemia inadvertida, es decir, episodios de azúcar baja sin síntomas de advertencia. La elegibilidad debe ser evaluada por un médico especialista."
  - pregunta: "¿Puede este trasplante eliminar la necesidad de insulina?"
    respuesta: "Según Breakthrough T1D, la investigación ha mostrado que estos procedimientos pueden reducir significativamente —o incluso eliminar— la necesidad de administrar insulina externamente en algunos pacientes, aunque esto no ocurre en todos los casos y depende de la evaluación médica individual."
  - pregunta: "¿Por qué no está más disponible este procedimiento actualmente?"
    respuesta: "Breakthrough T1D señala que la clasificación regulatoria actual en EE. UU. (como biológico en lugar de órgano), la escasez de donantes y la falta de cobertura de seguros son los principales obstáculos para ampliar el acceso a este tratamiento."
entidades:
  - nombre: "Diabetes mellitus tipo 1"
    tipo: "MedicalCondition"
    wikipedia: "https://es.wikipedia.org/wiki/Diabetes_mellitus_tipo_1"
...
*Fuente: <a href="https://www.breakthrought1d.org/news-and-updates/deceased-donor-islet-cell-transplantation-101/" rel="nofollow">Breakthrough T1D</a>*
