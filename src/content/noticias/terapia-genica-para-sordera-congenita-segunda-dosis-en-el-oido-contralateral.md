---
titulo: "Terapia génica para sordera congénita: segunda dosis en el oído contralateral muestra resultados prometedores"
resumen: "Un ensayo clínico de brazo único publicado en Nature Medicine evaluó la readministración de terapia génica AAV1-hOTOF en el oído opuesto de cuatro niños con sordera congénita por mutaciones en OTOF, observando mejoras auditivas sin toxicidades graves en un seguimiento de hasta 52 semanas."
porQueImporta: "La sordera congénita afecta a miles de niños en América Latina y las opciones terapéuticas son limitadas; este estudio abre una posible vía para tratar ambos oídos con terapia génica, lo que podría mejorar la localización del sonido y la calidad de vida de los pacientes."
categoria: "Investigación Clínica"
fuente:
  nombre: "Nature Medicine"
  url: "https://www.nature.com/articles/s41591-026-04505-4"
fecha: 2026-06-26T00:00:00+00:00
tags:
  - "terapia-genica"
  - "sordera-congenita"
  - "otof"
  ...
  - "ensayo-clinico"
faqs:
  - pregunta: "¿Qué es la sordera relacionada con el gen OTOF?"
    respuesta: "Es una forma de sordera neurosensorial congénita causada por mutaciones en el gen OTOF, que afecta la transmisión de señales sonoras desde el oído interno hacia el nervio auditivo. Según los autores del estudio, esta condición puede tratarse de forma experimental con terapia génica."
  - pregunta: "¿Por qué es difícil dar una segunda dosis de terapia génica?"
    respuesta: "Según el estudio publicado en Nature Medicine, la primera dosis genera anticuerpos neutralizantes en el organismo que pueden bloquear la efectividad de una segunda administración. Los investigadores exploraron si dirigir la segunda dosis al oído opuesto podría sortear este obstáculo inmunológico."
  - pregunta: "¿Qué resultados auditivos se observaron en los niños que recibieron la segunda dosis?"
    respuesta: "Los autores reportaron que el umbral auditivo promedio en el oído tratado mejoró desde más de 95 dB antes del tratamiento hasta valores de entre 43 dB y 80 dB a las 26 semanas en los cuatro pacientes, lo que indica una mejoría en la capacidad de percibir sonidos."
  - pregunta: "¿Esta terapia génica ya está disponible para el público general?"
    respuesta: "No. Según el estudio, se trata de un ensayo clínico en fase de investigación con solo cuatro pacientes, y los propios autores señalan que se necesitan estudios más amplios y seguimientos más prolongados antes de poder establecer conclusiones definitivas sobre su seguridad y eficacia."
entidades:
  - nombre: "Terapia génica"
    tipo: "MedicalProcedure"
    wikipedia: "https://es.wikipedia.org/wiki/Terapia_g%C3%A9nica"
  - nombre: "Sordera neurosensorial"
    tipo: "MedicalCondition"
    wikipedia: "https://es.wikipedia.org/wiki/Hipoacusia_neurosensorial"
...
*Fuente original: Fan X. et al., "Re-administration of AAV-mediated gene therapy for OTOF-related deafness: a single-arm trial", Nature Medicine (2026). <a href="https://doi.org/10.1038/s41591-026-04505-4" rel="nofollow">https://doi.org/10.1038/s41591-026-04505-4</a>*
