---
titulo: "Políticas de integración VIH y enfermedades crónicas en países de bajos ingresos: ¿qué falta?"
resumen: "Un análisis de documentos de política de la OMS, PEPFAR y 22 países reveló compromisos formales para integrar enfermedades no transmisibles en la atención del VIH, pero con brechas importantes en financiamiento, tecnología y acceso a medicamentos."
porQueImporta: "América Latina concentra una proporción significativa de personas viviendo con VIH en países de ingresos medios, donde la carga simultánea de enfermedades crónicas como hipertensión y diabetes representa un desafío creciente para sistemas de salud ya limitados."
categoria: "Salud Pública y Política"
fuente:
  nombre: "PLOS Global Public Health"
  url: "https://journals.plos.org/globalpublichealth/article?id=10.1371/journal.pgph.0007072"
fecha: 2026-08-07T14:00:00+00:00
tags:
  - "vih"
  ...
  - "salud-publica"
faqs:
  - pregunta: "¿Por qué las personas con VIH también desarrollan enfermedades crónicas como diabetes o hipertensión?"
    respuesta: "Según el estudio, el acceso a la terapia antirretroviral ha permitido que las personas con VIH vivan más años, lo que aumenta su exposición a enfermedades propias del envejecimiento. Se estima que el 20% de las personas con diagnóstico de VIH tienen al menos una enfermedad no transmisible."
  - pregunta: "¿Qué es la integración de la atención del VIH con enfermedades no transmisibles?"
    respuesta: "Consiste en que los mismos sistemas y establecimientos de salud que atienden el VIH también ofrezcan tamizaje y tratamiento para condiciones como hipertensión, diabetes, cáncer cervicouterino y depresión, mejorando la eficiencia y los resultados de salud para los pacientes."
  - pregunta: "¿Qué encontró el estudio sobre las políticas de integración en países de bajos ingresos?"
    respuesta: "Los investigadores observaron que, si bien existe un compromiso formal en los documentos de política de la OMS, PEPFAR y los países analizados, hay variación en qué enfermedades se priorizan y escasas menciones a financiamiento, tecnología de información y acceso a medicamentos."
  - pregunta: "¿Por qué el consumo de tabaco y alcohol recibe poca atención en las políticas de VIH?"
    respuesta: "Según el análisis, las menciones al tamizaje y tratamiento de factores de riesgo como el tabaco y el alcohol fueron escasas en los documentos revisados, lo que sugiere que estos servicios podrían estar comparativamente subfinanciados dentro de los programas de VIH."
  - pregunta: "¿Cómo pueden afectar los recortes de financiamiento internacional a la integración de servicios de VIH y ENT?"
    respuesta: "Los autores advierten que las reducciones en el financiamiento de PEPFAR y UNAIDS anunciadas en 2025 podrían afectar los esfuerzos futuros de integración, aunque estos cambios ocurrieron después del período de recolección de datos del estudio."
entidades:
  - nombre: "VIH/SIDA"
...
*Fuente original: Kapur R, et al. (2026). A content analysis of global and national policies, plans, and guidelines to integrate NCDs with HIV care in LMICs. PLOS Global Public Health 6(8): e0007072. <a href="https://journals.plos.org/globalpublichealth/article?id=10.1371/journal.pgph.0007072" rel="nofollow">https://doi.org/10.1371/journal.pgph.0007072</a>*
