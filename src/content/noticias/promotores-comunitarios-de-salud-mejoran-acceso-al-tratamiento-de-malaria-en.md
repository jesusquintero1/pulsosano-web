---
titulo: "Promotores comunitarios de salud mejoran acceso al tratamiento de malaria en Kenia"
resumen: "Un estudio piloto en el condado de Kilifi, Kenia, halló que promotores comunitarios de salud gestionaron el 17% de los casos de malaria no complicada, ampliando el acceso en zonas con escasa cobertura sanitaria."
porQueImporta: "El modelo de promotores comunitarios para el manejo de la malaria es relevante para regiones latinoamericanas con acceso limitado a centros de salud, donde estrategias similares podrían fortalecer la detección y el tratamiento oportuno de enfermedades infecciosas."
categoria: "Investigación Clínica"
fuente:
  nombre: "PLOS Global Public Health"
  url: "https://journals.plos.org/globalpublichealth/article?id=10.1371/journal.pgph.0006478"
fecha: 2026-07-06T14:00:00+00:00
tags:
  - "malaria"
  - "salud-comunitaria"
  - "promotores-de-salud"
...
faqs:
  - pregunta: "¿Qué es la gestión comunitaria de casos de malaria?"
    respuesta: "Según el estudio, la gestión comunitaria de casos de malaria (CCMm) es un enfoque en el que promotores de salud capacitados realizan la detección y el manejo de casos de malaria no complicada directamente en las comunidades, sin que los pacientes deban trasladarse a un establecimiento de salud."
  - pregunta: "¿Qué resultados tuvo el piloto de promotores comunitarios en Kilifi?"
    respuesta: "De acuerdo con el estudio, en un piloto con 10 establecimientos de salud en el condado de Kilifi, los promotores comunitarios gestionaron 1.268 de 7.568 casos de malaria registrados, lo que representa el 17% del total."
  - pregunta: "¿Este modelo de atención comunitaria podría aplicarse en América Latina?"
    respuesta: "El estudio no aborda directamente su aplicabilidad en América Latina, pero los investigadores señalan que la CCMm es una estrategia útil para ampliar el acceso en zonas desatendidas, un desafío que también enfrentan muchas regiones de la región."
  - pregunta: "¿Cuáles fueron los principales desafíos identificados en la implementación?"
    respuesta: "El resumen disponible del estudio menciona que los investigadores identificaron tanto facilitadores como desafíos en la implementación, aunque no los detalla exhaustivamente en el extracto publicado."
entidades:
  - nombre: "Malaria"
