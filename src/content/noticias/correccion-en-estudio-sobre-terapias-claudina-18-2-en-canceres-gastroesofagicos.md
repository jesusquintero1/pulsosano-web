---
titulo: "Corrección en estudio sobre terapias claudina 18.2 en cánceres gastroesofágicos"
resumen: "Nature Medicine publicó una corrección a un artículo sobre terapias dirigidas a claudina 18.2 en cánceres gastroesofágicos, ajustando cifras de toxicidad gastrointestinal del agente IBI343. Los datos corregidos muestran tasas de náuseas y vómitos considerablemente menores a las reportadas inicialmente."
porQueImporta: "Los cánceres gástricos y esofágicos representan una carga significativa en América Latina; conocer con precisión el perfil de efectos adversos de nuevas terapias dirigidas es esencial para que los equipos médicos evalúen opciones de tratamiento."
categoria: "Investigación Clínica"
fuente:
  nombre: "Nature Medicine"
  url: "https://www.nature.com/articles/s41591-026-04569-2"
fecha: 2026-07-16T00:00:00+00:00
tags:
  - "claudina-18-2"
  - "cancer-gastrico"
  - "cancer-gastroesofagico"
  - "ibi343"
  - "oncologia"
  - "correccion-cientifica"
faqs:
  - pregunta: "¿Qué es claudina 18.2 y por qué se usa como blanco en el cáncer gástrico?"
    respuesta: "Claudina 18.2 es una proteína que se sobreexpresa en la superficie de ciertas células tumorales gástricas y esofágicas, lo que la convierte en un blanco atractivo para terapias dirigidas como anticuerpos monoclonales y conjugados anticuerpo-fármaco, según el contexto del artículo revisado en Nature Medicine."
  - pregunta: "¿Qué error se corrigió en el artículo de Nature Medicine sobre claudina 18.2?"
    respuesta: "Según la corrección publicada, las cifras de náuseas y vómitos asociadas al agente IBI343 estaban incorrectamente reportadas. Los datos corregidos indican tasas de náuseas del 41,4% y vómitos del 25,0%, considerablemente menores a las cifras originales del 63% y 57%, respectivamente."
  - pregunta: "¿Qué es IBI343 y en qué se diferencia de otros agentes similares?"
    respuesta: "IBI343 es un conjugado anticuerpo-fármaco dirigido a claudina 18.2 que incorpora un diseño de 'silenciamiento Fc', una modificación que busca reducir la activación inmunitaria no deseada. Según la corrección publicada, sus tasas de toxicidad gastrointestinal son numéricamente menores a las del agente SHR-A1904, que carece de esa modificación."
  - pregunta: "¿Los resultados de IBI343 son definitivos?"
    respuesta: "No. Según los autores de la corrección publicada en Nature Medicine, los datos actuales provienen de estudios en fases tempranas y se esperan resultados de ensayos de fase III en curso para confirmar si el diseño de silenciamiento Fc se traduce en una reducción real de la toxicidad gastrointestinal."
  - pregunta: "¿Debo cambiar mi tratamiento oncológico basándome en esta información?"
    respuesta: "No. Esta información es de carácter divulgativo y proviene de una corrección editorial a un artículo científico. Cualquier decisión sobre tratamientos oncológicos debe tomarse en consulta con un médico especialista que evalúe cada caso de manera individual."
entidades:
  - nombre: "Claudina 18.2"
