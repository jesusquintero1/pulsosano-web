---
titulo: "FDA aprueba el primer tratamiento para la hepatitis delta crónica"
resumen: "La Administración de Alimentos y Medicamentos de EE. UU. (FDA) aprobó el primer tratamiento específico para la infección crónica por el virus de la hepatitis delta, una enfermedad hepática que solo afecta a personas que ya tienen hepatitis B."
porQueImporta: "La hepatitis delta es considerada la forma más grave de hepatitis viral y afecta a millones de personas en todo el mundo, incluyendo América Latina, donde la hepatitis B tiene presencia significativa. Contar con un tratamiento aprobado representa un avance relevante para quienes viven con esta coinfección."
categoria: "Avances Médicos"
fuente:
  nombre: "JAMA (Current Issue)"
  url: "https://jamanetwork.com/journals/jama/fullarticle/2850528"
...
tags:
  ...
  - "coinfeccion-viral"
faqs:
  - pregunta: "¿Qué es la hepatitis delta y cómo se diferencia de la hepatitis B?"
    respuesta: "Según la información publicada en JAMA, la hepatitis delta es una enfermedad hepática causada por un virus que solo puede infectar a personas que ya tienen hepatitis B, ya que depende de ese virus para replicarse. Es decir, no puede existir de forma independiente."
  - pregunta: "¿Por qué es importante que la FDA haya aprobado un tratamiento para la hepatitis delta?"
    respuesta: "De acuerdo con lo reportado por JAMA, hasta esta aprobación no existía ningún tratamiento formalmente autorizado por la FDA para la infección crónica por el virus de la hepatitis delta, lo que convierte esta decisión en un hito en el manejo de esta enfermedad."
  - pregunta: "¿Quiénes pueden tener hepatitis delta?"
    respuesta: "Según el material publicado en JAMA, la hepatitis delta solo ocurre en personas que tienen infección por el virus de la hepatitis B. No es posible contraer hepatitis delta sin tener previamente o simultáneamente hepatitis B."
  - pregunta: "¿Este tratamiento aprobado por la FDA está disponible en América Latina?"
    respuesta: "La aprobación reportada por JAMA corresponde a la FDA de Estados Unidos. La disponibilidad en países latinoamericanos dependerá de los procesos de aprobación de cada agencia regulatoria nacional; se recomienda consultar con un médico especialista para obtener información actualizada en cada país."
entidades:
  - nombre: "Hepatitis delta"
    tipo: "MedicalCondition"
    wikipedia: "https://es.wikipedia.org/wiki/Hepatitis_D"
  - nombre: "Hepatitis B"
    tipo: "MedicalCondition"
...
*Fuente original: JAMA. [FDA Approves First Treatment for Chronic Hepatitis Delta Virus Infection](https://jamanetwork.com/journals/jama/fullarticle/2850528){rel="nofollow"}*
